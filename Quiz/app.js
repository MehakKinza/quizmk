var questions = [{
    ...
    choices: ["Hyper Text Makeup Language", "Hello Text Make Language;", "Hypertext Markup Language", "HTML"],
    correctAnswer: 2
}, {
    question: "2. Who is making the Web standards??",
    choices: ["Google", "Microsoft", "Mozilla", "The World Wide Web Consortium"],
    correctAnswer: 3
}, {
    ...
    choices: ["lb", "br", "hr", "break"],
    correctAnswer: 1
}, {
    question: "5. How Many Heading in HTML",
    choices: ["1", "6", "5", "0"],
    correctAnswer: 1
	}
